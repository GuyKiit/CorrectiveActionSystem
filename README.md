...
ขั้นตอนการทำงานของระบบ Corrective Action แบ่งตามประเภทเอกสาร:

### ประเภทเอกสาร

| ประเภท | ชื่อเต็ม | ระดับการอนุมัติ |
|---|---|---|
| **CAR** | Corrective Action Request | หัวหน้าแผนก → ผู้จัดการโรงงาน |
| **NCR** | Non-Conformance Report | หัวหน้าแผนก |
| **OBS** | Observation | หัวหน้าแผนก |

### Flow: CAR (ต้องผ่านผู้จัดการโรงงาน)

```mermaid
flowchart LR
    A["📝 Complaint<br/>ผู้ร้องเรียนสร้างรายการ"] --> B["💬 Explaint<br/>ผู้รับผิดชอบชี้แจง"]
    B --> C["✅ Approve<br/>หัวหน้าแผนก"]
    C -->|ไม่อนุมัติ| B
    C -->|อนุมัติ| D["✅ Approve<br/>ผู้จัดการโรงงาน"]
    D -->|ไม่อนุมัติ| B
    D -->|อนุมัติ| E["🔒 Close<br/>ผู้ร้องเรียนปิดรายการ"]
```

### Flow: NCR / OBS (ข้ามผู้จัดการโรงงาน)
...
flowchart LR
    ...
    B --> C["✅ Approve<br/>หัวหน้าแผนก"]
    C -->|ไม่อนุมัติ| B
    C -->|อนุมัติ| D["🔒 Close<br/>ผู้ร้องเรียนปิดรายการ"]
```
...
| **Approve (หัวหน้าแผนก)** | หัวหน้าแผนก | ตรวจสอบและอนุมัติการชี้แจง (ทุกประเภทเอกสาร) |
| **Approve (ผู้จัดการโรงงาน)** | ผู้จัดการโรงงาน | อนุมัติขั้นสุดท้าย (เฉพาะ **CAR** เท่านั้น) |
